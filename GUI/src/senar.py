...
DATA_PATH = routes.juntarConPadre(__file__, 'Aprendizaje_Dinamico_AD')
...
"""
model_dir = routes.juntarConPadre(__file__, 'action2.h5')
    ...
    def get_frame(self):
        ...
        with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            while self.cap.isOpened():
                ...
                cv2.rectangle(image, (0,0), (640, 40), (255, 102, 102), -1)
